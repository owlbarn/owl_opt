...
module S : sig
  (** Single-precision vanilla gradient descent *)
  module Gd : module type of Gd_s

  (** Single-precision Adam *)
  module Adam : module type of Adam_s

  (** Single-precision Rmsprop *)
  module Rmsprop : module type of Rmsprop_s
end

(** {1 Double-precision module} *)

module D : sig
  (** Double-precision vanilla gradient descent *)
  module Gd : module type of Gd_d

  (** Double-precision Adam *)
  module Adam : module type of Adam_d

  (** Double-precision Rmsprop *)
  module Rmsprop : module type of Rmsprop_d
end
